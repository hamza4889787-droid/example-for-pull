        ...
        <div className={styles.content}>
          ...
          <div className={styles['welcome-banner']}>
            <div className={styles['wb-left']}>
              <div className={styles['wb-tag']}>Your Journey Dashboard</div>
              <div className={styles['wb-title']}>Welcome back, Ron</div>
              <div className={styles['wb-sub']}>
                You're in Stage 1 · Getting Started · Module 2 of 10<br />
                You're not in a rush. Take each step with intention.
              </div>
              <div className={styles['wb-scripture']}>
                "For I know the plans I have for you," declares the Lord — Jeremiah 29:11
              </div>
            </div>
            <Link to="/where-i-am-now" style={{ textDecoration: 'none', color: 'white' }} className={styles['wb-right']}>
            ...
            <div className={styles['roadmap-header']}>
              ...
              <div className={styles['stage-legend']}>
                <div className={styles['leg-item']}>
                  <div className={styles['leg-dot']} style={{ background: 'var(--done)' }}></div>Completed
                </div>
                <div className={styles['leg-item']}>
                  <div className={styles['leg-dot']} style={{ background: 'var(--gs)' }}></div>In Progress
                </div>
                <div className={styles['leg-item']}>
                  <div className={styles['leg-dot']} style={{ background: 'rgba(255,255,255,0.25)' }}></div>Locked
                </div>
              </div>
            </div>
            ...
            <div className={styles['stage-grid']}>
              ...
              <div className={styles['stage-col']}>
                ...
                <div className={styles['stage-body-gs']}>
                  <Link to="/dashboard" style={{ textDecoration: 'none' }}> <div className={`${styles['mod-node']} ${styles.completed}`}>
                    <div className={styles['mn-icon-row']}>
                      <span className={styles['mn-icon']}>
                        <i className="fa fa-bullseye" style={{ color: '#27ae60' }}></i>
                      </span>
                      <span className={`${styles['mn-badge']} ${styles['mb-done']}`}>
                  ...
                  <Link to="/where-i-am-now" style={{ textDecoration: 'none' }}>
                    <div className={`${styles['mod-node']} ${styles.active}`}>
                      <div className={styles['mn-icon-row']}>
                        <span className={styles['mn-icon']}>
                          <i className="fa fa-search" style={{ color: '#3a8fb5' }}></i>
                        </span>
                        <span className={`${styles['mn-badge']} ${styles['mb-active']}`}>
                          <i className="fa fa-play"></i> Active
                        </span>
                      </div>
              ...
              <div className={styles['stage-col']}>
                <div className={`${styles['stage-header']} ${styles['sh-p']}`}>
                  ...
                  <div>
                    ...
                    <div className={styles['stage-mods']}>4 modules · Locked</div>
                  </div>
                </div>

                <div className={styles['stage-body-p']}>
                  {['How I Got Here', 'How I\'m Wired', 'What Stops Me', 'Perspective'].map((title, idx) => (
                    <div key={idx} className={`${styles['mod-node']} ${styles.locked}`}>
                      <div className={styles['mn-icon-row']}>
                        <span className={styles['mn-icon']}>
                          <i className={`fa ${idx === 0 ? 'fa-history' : idx === 1 ? 'fa-connectdevelop' : idx === 2 ? 'fa-shield' : 'fa-binoculars'}`} style={{ color: 'rgba(255,255,255,0.3)' }}></i>
                        </span>
                        <span className={`${styles['mn-badge']} ${styles['mb-locked']}`}>
              ...
              <div className={styles['stage-col']}>
                <div className={`${styles['stage-header']} ${styles['sh-s']}`}>
                  ...
                  <div>
                    ...
                    <div className={styles['stage-mods']}>1 module · Locked</div>
                  </div>
                </div>
                <div className={styles['stage-body-s']}>
                  <div className={`${styles['mod-node']} ${styles.locked}`}>
                    <div className={styles['mn-icon-row']}>
                      <span className={styles['mn-icon']}>
                        <i className="fa fa-leaf" style={{ color: 'rgba(255,255,255,0.3)' }}></i>
                      </span>
                      <span className={`${styles['mn-badge']} ${styles['mb-locked']}`}>
                        <i className="fa fa-lock"></i> Locked
                      </span>
              ...
              <div className={styles['stage-col']}>
                <div className={`${styles['stage-header']} ${styles['sh-lp']}`}>
                  ...
                  <div>
                    ...
                    <div className={styles['stage-mods']}>3 modules · Locked</div>
                  </div>
                </div>
                <div className={styles['stage-body-lp']}>
                  {['My Purpose', 'My Future', 'Next Steps'].map((title, idx) => (
                    <div key={idx} className={`${styles['mod-node']} ${styles.locked}`}>
                      <div className={styles['mn-icon-row']}>
                        <span className={styles['mn-icon']}>
                          <i className={`fa ${idx === 0 ? 'fa-star-o' : idx === 1 ? 'fa-sun-o' : 'fa-list-ul'}`} style={{ color: 'rgba(255,255,255,0.3)' }}></i>
                        </span>
                        <span className={`${styles['mn-badge']} ${styles['mb-locked']}`}>
                          <i className="fa fa-lock"></i> Locked
                        </span>
          ...
          <div className={styles['bottom-row']}>
            <div className={styles['current-module-card']}>
              ...
              <div className={styles['cm-title']}>Where I Am Now</div>
              <div className={styles['cm-sub']}>Current State Assessment · Module 2 of 10</div>
              <div className={styles['cm-desc']}>
                Take an honest, compassionate look at where you stand today across the key domains of life. Your AI guide will walk you through each area with reflective questions — one domain at a time.
              </div>
              <div className={styles['cm-actions']}>
                <Link to="/where-i-am-now" style={{ textDecoration: 'none' }}>
                  <button className={styles['btn-primary']}>▶ Open Module</button>
                </Link>
                <button className={styles['btn-ghost']}>Review Module 1</button>
              </div>
            </div>
            {/* 
