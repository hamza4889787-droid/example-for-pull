...
const WhereIAmNow = () => {
  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles['left-panel']}>
            ...
            <div className={styles['mod-header']}>
              <div className={styles['mod-eyebrow']}>📍 Stage 1 · Getting Started · Module 2 of 10</div>
              <div className={styles['mod-title']}>Where I Am Now</div>
              <div className={styles['mod-subtitle']}>Current State Assessment — A 360° View of My Life Right Now</div>
              <div className={styles['mod-desc']}>
                Before charting a path forward, you need an honest picture of where you stand today.
                This module helps you assess your current season across the key domains of life — not to judge, but to see clearly.
              </div>
              <div className={styles['instruction-box']}>
                <div className={styles['ib-title']}><i className="fa fa-microchip" style={{ color: '#fff' }}></i> How This Works</div>
                <div className={styles['ib-text']}>
                  Your AI guide on the right will walk you through each life domain — one at a time.
                  Answer openly and honestly. When finished, save your summary in the box below. You can always return to edit.
                </div>
              </div>
            </div>
            ...
            <div className={styles['chat-window']}>
              ...
              <div className={styles['chat-messages']}>
                <div className={styles.msg}>
                  ...
                  <div className={styles['msg-body']}>
                    <div className={`${styles.bubble} ${styles.ai}`}>
                      Welcome, Ron. I'm here to walk with you through your Current State Assessment.<br/><br/>
                      This isn't a test — it's simply a chance to see where you are today, across the different areas of your life. We'll move through each domain at your pace.<br/><br/>
                      Let's start with your <strong>personal life</strong>. When you sit with yourself quietly — how would you describe your inner world right now?
                    </div>
                ...
                <div className={`${styles.msg} ${styles.user}`}>
                  ...
                  <div className={styles['msg-body']}>
                    <div className={`${styles.bubble} ${styles.user}`}>
                      Honestly, there's a restlessness I can't quite shake. I've been successful by most measures but something feels... unfinished. Like I'm moving through life on autopilot.
                    </div>
                ...
                <div className={styles.msg}>
                  ...
                  <div className={styles['msg-body']}>
                    <div className={`${styles.bubble} ${styles.ai}`}>
                      That's a really significant thing to name, Ron. "Successful but restless" — that tension is actually one of the most important clues we can start with.<br/><br/>
                      When you say it feels unfinished — is there a particular area of life where that feeling is loudest?
                    </div>
                    <div className={styles['msg-time']}>LifePlan Guide</div>
                  </div>
                </div>
                ...
                <div className={`${styles.msg} ${styles.user}`}>
                  ...
                  <div className={styles['msg-body']}>
                    <div className={`${styles.bubble} ${styles.user}`}>
                      My work, for sure. I've built something I'm proud of, but I'm not sure it's what I'm supposed to be doing long-term. And spiritually, I feel like I've been coasting.
                    </div>
                    <div className={styles['msg-time']}>Ron</div>
                  </div>
                </div>
                ...
                <div className={styles.msg}>
                  ...
                  <div className={styles['msg-body']}>
                    <div className={`${styles.bubble} ${styles.ai}`}>
                      Good. Let's hold both of those — we'll come back to each in depth.<br/><br/>
                      You mentioned coasting spiritually. That word is interesting — coasting suggests you know there's a deeper current you're not fully in. What does a <strong>more connected</strong> spiritual life look like for you, even if it's just a memory or a feeling?
                    </div>
                    <div className={styles['msg-time']}>LifePlan Guide</div>
                  </div>
                </div>
                ...
                <div className={`${styles.msg} ${styles.user}`}>
                  ...
                  <div className={styles['msg-body']}>
                    <div className={`${styles.bubble} ${styles.user}`}>
                      There have been seasons where prayer felt natural, even joyful. Morning time with God before everything got loud. That's been rare lately.
                    </div>
                    <div className={styles['msg-time']}>Ron</div>
                  </div>
                </div>
                ...
                <div className={styles.msg}>
                  ...
                  <div className={styles['msg-body']}>
                    ...
                    <div className={styles['msg-time']}>LifePlan Guide · typing...</div>
                  </div>
                </div>
              </div>

              <div className={styles['chat-input-area']}>
                <textarea className={styles['chat-input']} placeholder="Share your thoughts..." rows={1}></textarea>
      ...
      <div className={styles['screen-badge']}>Screen 2 of 6 — Module 2: Where I Am Now</div>
    </div>
  );
};
